...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.a07415>
...
# Solaris, Linux
CCOPTIONS=-DBIGFONT=\"fixed\" -DSMALLFONT=\"6x10\" -O
...
install.man:: sunclock.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(INSTALL) $(INSTALLFLAGS) $(INSTMANFLAGS) sunclock.man $(DESTDIR)$(MANDIR)/sunclock.$(MANSUFFIX)
...
# ----------------------------------------------------------------------
# common rules system V or Solaris all Makefiles - do not edit
...
# ----------------------------------------------------------------------
# empty rules system V or Solaris directories that do not have SUBDIRS - do not edit
